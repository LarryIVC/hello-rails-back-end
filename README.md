...
**Hello Rails React** is an application that allows users to show a random greeting. The app is built with Ruby on Rails. The app create an API. 
...
```sh
  ...
  git clone git@github.com:LarryIVC/hello-rails-back-end.git
```
